...
void LowPassModule::prepare (double sampleRate, unsigned int samplesPerBlock, unsigned int numChannels)
{
...
void LowPassModule::process (juce::AudioBuffer<float>& buffer, juce::MidiBuffer& midiMessages, float cutoff)
{
